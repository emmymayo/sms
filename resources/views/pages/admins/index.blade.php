    ...
    <x-header title="Admins " >
        ...
        <link rel="stylesheet" href="/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
            ...
            <div class="content-wrapper" style="min-height: 264px;">
                ...
                <div class="content">
                <div class="container-fluid">
                <div> <a href="/admins/create" class="btn btn-app bg-blue "><i class="fas fa-user-plus"></i> Add Admin</a></div>
                <br>
                ...
                <div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                  <h5><i class="icon fas fa-check"></i> Admin Removed</h5>
                        ...
                        @endphp
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a class="dropdown-item" href="/admins/{{$admin->id}}"><i class="fas fa-eye"></i> Profile</a>
                                    
                                    <a class="dropdown-item" href="/users/{{$admin->user->id}}/reset-password"><i class="fas fa-lock"></i> Reset Password</a>
                                    <a class="dropdown-item" href="/users/{{$admin->user->id}}/toggle-status"><i class="fas fa-toggle-on"></i> Change Status</a>
                                    <div class="dropdown-divider"></div>
                                    <form action="/admins/{{$admin->id}}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                         @csrf 
                                         @method('DELETE')
