    ...
    <x-header title="Admin Profile | {{$profile->user->name}} " >
            ...
            <div class="content-wrapper" style="min-height: 264px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                        ...
                        <li class="breadcrumb-item active"><a href="/admins/{{$profile->id}}">{{$profile->user->name}}</a></li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="edit_profile">
                                <form class="form-horizontal" action="/admins/{{$profile->id}}" method="POST">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" id="position" name="position" 
                                            placeholder="Administrative Position" value="{{$profile->position}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" id="contact" name="contact" 
                                            placeholder="Contact Information" value="{{$profile->contact}}">
                                    </div>
                                </div>
