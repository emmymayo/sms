<x-header title="Manage Products - Add">
</x-header>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="/product-management/create">Add Product</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default card-tabs">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="/product-management" class="">
                  @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" value="{{old('description')}}" id="description" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id="price-input-wrapper">
                            ...
                            <input type="number" step="0.01" class="form-control" value="{{old('price')}}" name="price" id="price" />
                        </div>
